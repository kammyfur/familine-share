            ...
            <?php foreach ($_CONF_USP['files'] as $file): ?>
                <tr>
                    ...
                    <td style="vertical-align: middle;">
                        <div class="btn-group">
                            <a target="_blank" href="https://flh.fr.to/f/<?= $file['id'] ?>" type="button" class="btn btn-success">Voir</a>
                            <input id="link-<?= $file['id'] ?>" value="https://flh.fr.to/f/<?= $file['id'] ?>" type="text" style="opacity: 0;pointer-events: none;position:fixed;">
